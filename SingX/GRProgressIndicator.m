...
#define kIndeterminateParticleSpacing 16.0
    ...
    if(!_indeterminateGradient) {
        _indeterminateGradientColor0 = [NSColor colorWithCalibratedRed: 0.6 green: 0 blue: 0 alpha: 1];
        _indeterminateGradientColor1 = [NSColor colorWithCalibratedRed: 0.5 green: 0 blue: 0 alpha: 1];
        _indeterminateGradientColor2 = [NSColor colorWithCalibratedRed: 0.5 green: 0 blue: 0 alpha: 1];
        _indeterminateGradientColor3 = [NSColor colorWithCalibratedRed: 0.4 green: 0 blue: 0 alpha: 1];
