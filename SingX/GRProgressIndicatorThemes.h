...
#define kProgressBarGradientColor0 [NSColor colorWithCalibratedRed: 1 green: 0 blue: 0 alpha: 1]
#define kProgressBarGradientColor1 [NSColor colorWithCalibratedRed: 1 green: 0 blue: 0 alpha: 1]
#define kProgressBarGradientColor2 [NSColor colorWithCalibratedRed: 1 green: 0 blue: 0 alpha: 1]
#define kProgressBarGradientColor3 [NSColor colorWithCalibratedRed: 1 green: 0 blue: 0 alpha: 1]
#define kProgressBarGradientColor4 [NSColor colorWithCalibratedRed: 1 green: 0 blue: 0 alpha: 1]
